...
> **Note**
> This project was generated by the [`mathbox/clerk`
> template](https://github.com/mentat-collective/MathBox.cljs/tree/main/resources/mathbox/clerk)
> from [`MathBox.cljs`](https://mathbox.mentat.org).

This project allows you to interactively develop [Clerk][clerk-url] notebooks
using [`MathBox.cljs`](https://mathbox.mentat.org) code inside of your project's
...
```clj
(clerk/show! "notebooks/maacl/feigenbaum.clj")
```
...
All ClojureScript code you add to `src/maacl/custom.cljs` is available
for use inside any [custom viewer code you
write](https://book.clerk.vision/#writing-viewers).

This is made possible by the code in `src/maacl/sci_viewers.cljs`. If you
...
- [Create a GitHub repository](https://github.com/new). Ideally the owner
  matches `maacl` and the project name is `feigenbaum`.
...
git branch -M main
git remote add origin git@github.com:maacl/feigenbaum.git
git push -u origin main
```

Then visit https://github.com/maacl/feigenbaum to see your site.
...
By default your site will live at https://maacl.github.io/feigenbaum.
...
https://github.clerk.garden/maacl/feigenbaum
